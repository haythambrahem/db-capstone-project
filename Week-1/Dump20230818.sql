...
CREATE TABLE `customer details` (
  `name` int NOT NULL,
  `Contact details` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order delivery status` (
  ...
  CONSTRAINT `order id` FOREIGN KEY (`order id`) REFERENCES `orders` (`order id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `order id` int NOT NULL,
  PRIMARY KEY (`order id`),
  KEY `name_idx` (`customer id`),
  CONSTRAINT `name` FOREIGN KEY (`customer id`) REFERENCES `customer details` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-08-18 18:37:38
